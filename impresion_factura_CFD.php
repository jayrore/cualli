<?php	
	...
	class PDF extends FPDF
	{
		...
		function reporte($conexion)
		{
			...
			while($reg=mysql_fetch_array($registro))
			{
				if ($cont==0) ///solo se imprime la primera vez
				{
					//////////////////////////////HEADER//////////////////////////////////
					 ...
					 $cadena_original=$reg["cadena_original"];
					...
					//Logos
					 ...
					 $this->Ln(4);
					 $this->Cell(80,3,utf8_decode("Teléfono ".$reg["e_telefono"]),0,0,'L',1);
					 $this->Cell(80,3,utf8_decode("Teléfono ".$reg["ep_telefono"]),0,0,'L',1);
					 $this->Ln(4);
			...
			$this->Ln(8);
			$this->Cell(190,3,"Cadena Original",0,0,'L',1);
			$this->Ln(4);
			$this->MultiCell(190,3,utf8_decode($cadena_original),0,'L');
			$this->Ln(4);
			$this->Cell(190,3,"Sello Digital  ",0,0,'L',1);
			$this->Ln(4);
			$this->MultiCell(190,3,utf8_decode($sello),0,'L');
			$this->Ln(4);
			$this->Cell(190,3,utf8_decode("ESTE DOCUMENTO ES UNA REPRESENTACIÓN IMPRESA DE UN CFD"),0,0,'C',1);
			$this->Ln(4);
